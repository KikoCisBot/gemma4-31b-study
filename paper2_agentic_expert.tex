...
QLoRA on Apple M4 Max (128\,GB unified memory) via MLX. LoRA rank~8 applied to all 42 layers (20.2M trainable parameters, 0.27\% of total). Training: 1500 iterations, learning rate $5 \times 10^{-5}$, batch size~2, max sequence length 2048.
